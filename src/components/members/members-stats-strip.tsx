    ...
    >
      <div className="mx-auto w-full max-w-6xl px-6 py-14 sm:py-16">
        ...
        <p className="mt-3 max-w-prose text-sm leading-relaxed text-muted">
          הספירה חיה מהמסד. למטה דוגמאות אקראיות כדי להבין את ההבדל לפני כניסה.
        </p>
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-2">
          ...
          <div>
            ...
            {publicSamples.length > 0 ? (
              ...
              <p className="mt-4 text-sm text-muted">אין דוגמאות פתוחות כרגע.</p>
            )}
          </div>
        </div>
      </div>
