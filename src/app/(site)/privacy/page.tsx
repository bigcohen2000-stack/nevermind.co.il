        ...
        <div className="mt-12 space-y-10 text-base leading-relaxed text-foreground/85">
          ...
          <section aria-labelledby="privacy-data">
            ...
            <ul className="mt-3 list-disc space-y-2 pe-5">
              ...
              <li>
                חשבון באתר: כתובת אימייל לקבלת קישור התחברות.
              </li>
              <li>
          ...
          <section aria-labelledby="privacy-cookies">
            ...
            <p className="mt-3">
              ...
              בנוסף נשמרות העדפות מקומיות בדפדפן שלכם (נגישות, ומצב תצוגה בהיר או
              כהה למי שמחובר). אין שימוש מצדנו בעוגיות מעקב פרסום של צד שלישי.
            </p>
            <p className="mt-4">
