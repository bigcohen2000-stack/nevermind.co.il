...
const CLUB_BENEFITS: { title: string; body: string }[] = [
  {
    title: "מאגר סרטונים לא רשומים",
    body: "צפייה בסרטונים חסומים של המועדון אחרי כניסה. הכותרות נשארות גלויות גם לפני כן.",
  },
  {
    title: "חיפוש מושגים ותמלילים",
    body: "מנוע חיפוש פנימי למושגים ולטקסט מתוך הסרטונים, כולל השלמה בעברית.",
  },
  {
    title: "חקירה קשורה",
    body: "מפאנל סרטונים נוספים לחקירה בנושא, ממשיכים לנושא הבא בלי להתחיל מאפס.",
  },
  {
    title: "מאמרים ומנגנונים",
    body: "גישה לתוכן הכתוב באתר ולמפת המנגנונים.",
  },
  {
    title: "קישור אישי",
    body: "קישור כניסה בוואטסאפ, או סיסמה. בלי סליקה באתר.",
  },
  {
    title: "תיאום שיחה",
    body: "בקשת גישה ובדיקת התאמה בוואטסאפ לפני פתיחת המאגר.",
  },
];
      ...
      <section aria-labelledby="members-hero-title" className="band-dark">
        ...
        <div className="relative z-10 mx-auto w-full max-w-6xl px-6 py-24 lg:py-32">
          ...
          <p className="mt-7 max-w-prose text-lg leading-relaxed text-foreground/80">
            ...
            סיסמה שקיבלתם בוואטסאפ. אין סליקה באתר.
          </p>
          {stats.clubVideos > 0 ? (
        ...
        <div className="mx-auto w-full max-w-6xl px-6 py-20 lg:py-28">
          ...
          <ol className="mt-12 grid gap-8 lg:grid-cols-3">
            ...
            <li>
              ...
              <p className="mt-3 leading-relaxed text-foreground/80">
                אחרי הכניסה, סרטוני המועדון נפתחים במכשיר הזה.
              </p>
            </li>
          </ol>
